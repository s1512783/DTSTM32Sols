...
void spiInit(SPI_TypeDef *SPIx)
{
	...
	// Configure pins & clocks
	if (SPIx == SPI2) { 
		// Clocks to GPIO and SPI
...
{
	SPI_DataSizeConfig(SPIx, SPI_DataSize_16b); //temporarily change data size to 16b
	...
	SPI_DataSizeConfig(SPIx, SPI_DataSize_8b); //change data size back to 8b
	return i;
}
